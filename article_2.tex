...
\fancyhead[C]{Comparación BD NoSQL $\bullet$ Junio 2019 $\bullet$ Trabajo, Final UII} % Custom header text
...
\title{Comparación BD NoSQL} % Article title
\author{%
